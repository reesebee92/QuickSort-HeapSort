 ...
 * output file of sorted integers using QuickSortB. This version of a QuickSort uses  
 * an optimized version of QuickSort using the first element of the partition as the 
 * pivot and resorts to a simple selection sort for partition of size k = 100.
 * 
 * @author SDantzler
 * @version 2.0
 * */
...
public class QuickSortB {
   ...
   public static void main(String[] args) throws IOException {
      ...
      if (args.length != 2) {
         System.out.println(
               "Usage: java QuickSortB [input file pathname] [output file pathname] ");
         System.exit(1);
      }
